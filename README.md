...
This is a cheat-sheet for using Solar icons in React.

https://www.svgrepo.com/collection/solar-outline-icons/

README from the Solar icons package pasted here, for reference:
...
<!--
import solar, { Chart } from "@solar-icons/react/ssr";
import { Business } from "@solar-icons/react/category";
<Business.Chart size={28} weight="Linear" />
-->
